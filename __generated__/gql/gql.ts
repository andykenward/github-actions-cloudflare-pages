...
type Documents = {
    ...
    "\n    mutation DeactivateAndDeleteGitHubDeploymentAndComment(\n      $deploymentId: ID!\n      $environment: String\n      $environmentUrl: String!\n      $logUrl: String!\n      $commentId: ID!\n    ) {\n      createDeploymentStatus(\n        input: {\n          autoInactive: false\n          deploymentId: $deploymentId\n          environment: $environment\n          environmentUrl: $environmentUrl\n          logUrl: $logUrl\n          state: INACTIVE\n        }\n      ) {\n        clientMutationId\n      }\n      deleteDeployment(input: {id: $deploymentId}) {\n        clientMutationId\n      }\n      deleteIssueComment(input: {id: $commentId}) {\n        clientMutationId\n      }\n    }\n  ": typeof types.DeactivateAndDeleteGitHubDeploymentAndCommentDocument,
...
const documents: Documents = {
    ...
    "\n    mutation DeactivateAndDeleteGitHubDeploymentAndComment(\n      $deploymentId: ID!\n      $environment: String\n      $environmentUrl: String!\n      $logUrl: String!\n      $commentId: ID!\n    ) {\n      createDeploymentStatus(\n        input: {\n          autoInactive: false\n          deploymentId: $deploymentId\n          environment: $environment\n          environmentUrl: $environmentUrl\n          logUrl: $logUrl\n          state: INACTIVE\n        }\n      ) {\n        clientMutationId\n      }\n      deleteDeployment(input: {id: $deploymentId}) {\n        clientMutationId\n      }\n      deleteIssueComment(input: {id: $commentId}) {\n        clientMutationId\n      }\n    }\n  ": types.DeactivateAndDeleteGitHubDeploymentAndCommentDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query PullRequestNodeId($owner: String!, $repo: String!, $number: Int!) {\n    repository(owner: $owner, name: $repo) {\n      pullRequest(number: $number) {\n        id\n      }\n    }\n  }\n"): typeof import('./graphql.js').PullRequestNodeIdDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query PullRequestNodeIdByBranch(\n    $owner: String!\n    $repo: String!\n    $headRefName: String!\n  ) {\n    repository(owner: $owner, name: $repo) {\n      pullRequests(first: 1, states: [OPEN], headRefName: $headRefName) {\n        nodes {\n          id\n        }\n      }\n    }\n  }\n"): typeof import('./graphql.js').PullRequestNodeIdByBranchDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n    mutation DeactivateAndDeleteGitHubDeploymentAndComment(\n      $deploymentId: ID!\n      $environment: String\n      $environmentUrl: String!\n      $logUrl: String!\n      $commentId: ID!\n    ) {\n      createDeploymentStatus(\n        input: {\n          autoInactive: false\n          deploymentId: $deploymentId\n          environment: $environment\n          environmentUrl: $environmentUrl\n          logUrl: $logUrl\n          state: INACTIVE\n        }\n      ) {\n        clientMutationId\n      }\n      deleteDeployment(input: {id: $deploymentId}) {\n        clientMutationId\n      }\n      deleteIssueComment(input: {id: $commentId}) {\n        clientMutationId\n      }\n    }\n  "): typeof import('./graphql.js').DeactivateAndDeleteGitHubDeploymentAndCommentDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
